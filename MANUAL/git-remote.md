...
When subcommands such as _add_, _rename_, and _remove_ can’t find the remote in question, the exit status is `2`. When the remote already exists, the exit status is `3`.
